...
fn main() {
    // Floor plane (y = 0 in object space; spheres sit on it)
    ...
    std::fs::write("media/images_ppm/three_spheres_on_plane.ppm", ppm)
        .expect("Failed to write three_spheres_on_plane.ppm");
    println!("Saved to media/images_ppm/three_spheres_on_plane.ppm");
}
