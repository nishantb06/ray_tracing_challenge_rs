...
use ray_tracing_challenge_rs::transformation::{
    scaling, translation, rotation_x, rotation_y, view_transform,
};
use std::f64::consts::{FRAC_PI_3, FRAC_PI_4, FRAC_PI_2};
...
fn main() {
    ...
    std::fs::write("media/images_ppm/three_spheres.ppm", ppm)
        .expect("Failed to write three_spheres.ppm");
    println!("Saved to media/images_ppm/three_spheres.ppm");
}
